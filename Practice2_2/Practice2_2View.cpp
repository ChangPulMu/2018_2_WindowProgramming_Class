...
// Practice2_2View.cpp : CPractice2_2View 클래스의 구현
//
...
CPractice2_2Doc* CPractice2_2View::GetDocument() const // 디버그되지 않은 버전은 인라인으로 지정됩니다.
{
...
void CPractice2_2View::OnSize(UINT nType, int cx, int cy)
{
	...
	m_strWindowSize.Format(_T("윈도우 크기는 넗이 %d, 높이 %d입니다."), cx, cy);
	// 화면 갱신
	Invalidate();
...
void CPractice2_2View::OnLButtonDown(UINT nFlags, CPoint point)
{
...
void CPractice2_2View::OnRButtonDown(UINT nFlags, CPoint point)
{
	// TODO: 여기에 메시지 처리기 코드를 추가 및/또는 기본값을 호출합니다.
...
void CPractice2_2View::OnKeyDown(UINT nChar, UINT nRepCnt, UINT nFlags)
{
	// TODO: 여기에 메시지 처리기 코드를 추가 및/또는 기본값을 호출합니다.
...
//void CPractice2_2View::OnDestroyClipboard()
//{
...
void CPractice2_2View::OnMouseMove(UINT nFlags, CPoint point)
{
	// TODO: 여기에 메시지 처리기 코드를 추가 및/또는 기본값을 호출합니다.
	if (m_bDrag == TRUE)
	{
...
void CPractice2_2View::OnLButtonUp(UINT nFlags, CPoint point)
{
	// TODO: 여기에 메시지 처리기 코드를 추가 및/또는 기본값을 호출합니다.
	m_bDrag = FALSE;
