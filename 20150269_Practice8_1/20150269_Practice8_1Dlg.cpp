...
// 20150269_Practice8_1Dlg.cpp : 구현 파일
//

#include "stdafx.h"
#include "20150269_Practice8_1.h"
#include "20150269_Practice8_1Dlg.h"
...
// CMy20150269_Practice8_1Dlg 대화 상자



CMy20150269_Practice8_1Dlg::CMy20150269_Practice8_1Dlg(CWnd* pParent /*=NULL*/)
	: CDialogEx(IDD_MY20150269_PRACTICE8_1_DIALOG, pParent)
	, m_nSize(0)
{
	m_hIcon = AfxGetApp()->LoadIcon(IDR_MAINFRAME);
}

void CMy20150269_Practice8_1Dlg::DoDataExchange(CDataExchange* pDX)
{
	CDialogEx::DoDataExchange(pDX);
...
BEGIN_MESSAGE_MAP(CMy20150269_Practice8_1Dlg, CDialogEx)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_NOTIFY(TCN_SELCHANGE, IDC_TAB_SELECTION, &CMy20150269_Practice8_1Dlg::OnSelchangeTabSelection)
	ON_NOTIFY(UDN_DELTAPOS, IDC_SPIN_SIZE, &CMy20150269_Practice8_1Dlg::OnDeltaposSpinSize)
END_MESSAGE_MAP()


// CMy20150269_Practice8_1Dlg 메시지 처리기

BOOL CMy20150269_Practice8_1Dlg::OnInitDialog()
{
...
void CMy20150269_Practice8_1Dlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
void CMy20150269_Practice8_1Dlg::OnPaint()
{
	if (IsIconic())
	{
...
//  이 함수를 호출합니다.
HCURSOR CMy20150269_Practice8_1Dlg::OnQueryDragIcon()
{
...
void CMy20150269_Practice8_1Dlg::UpdateDrawing()
{
	CRect rectView;
	GetDlgItem(IDC_STATIC_VIEW)->GetWindowRect(&rectView);
...
void CMy20150269_Practice8_1Dlg::OnSelchangeTabSelection(NMHDR *pNMHDR, LRESULT *pResult)
{
...
void CMy20150269_Practice8_1Dlg::OnDeltaposSpinSize(NMHDR *pNMHDR, LRESULT *pResult)
{
