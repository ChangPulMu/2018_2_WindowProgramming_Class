...
// 20150269_Practice8_2Dlg.cpp : 구현 파일
//

#include "stdafx.h"
#include "20150269_Practice8_2.h"
#include "20150269_Practice8_2Dlg.h"
...
// CMy20150269_Practice8_2Dlg 대화 상자



CMy20150269_Practice8_2Dlg::CMy20150269_Practice8_2Dlg(CWnd* pParent /*=NULL*/)
	: CDialogEx(IDD_MY20150269_PRACTICE8_2_DIALOG, pParent)
	, m_nTransmitRate(0)
	, m_nData(0)
{
...
void CMy20150269_Practice8_2Dlg::DoDataExchange(CDataExchange* pDX)
{
	CDialogEx::DoDataExchange(pDX);
...
BEGIN_MESSAGE_MAP(CMy20150269_Practice8_2Dlg, CDialogEx)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDC_BUTTON_TRANSMIT, &CMy20150269_Practice8_2Dlg::OnClickedButtonTransmit)
	ON_WM_TIMER()
END_MESSAGE_MAP()


// CMy20150269_Practice8_2Dlg 메시지 처리기

BOOL CMy20150269_Practice8_2Dlg::OnInitDialog()
{
...
void CMy20150269_Practice8_2Dlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
void CMy20150269_Practice8_2Dlg::OnPaint()
{
	if (IsIconic())
	{
...
//  이 함수를 호출합니다.
HCURSOR CMy20150269_Practice8_2Dlg::OnQueryDragIcon()
{
...
void CMy20150269_Practice8_2Dlg::OnClickedButtonTransmit()
{
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
	// 현재 데이터 전송률을 0%로 설정한다.
	m_nTransmitRate = 0;
...
void CMy20150269_Practice8_2Dlg::OnTimer(UINT_PTR nIDEvent)
{
