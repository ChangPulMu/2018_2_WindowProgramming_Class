...
// 20150269_Practice4_2Dlg.cpp : 구현 파일
//

#include "stdafx.h"
#include "20150269_Practice4_2.h"
#include "20150269_Practice4_2Dlg.h"
...
// CMy20150269_Practice4_2Dlg 대화 상자



CMy20150269_Practice4_2Dlg::CMy20150269_Practice4_2Dlg(CWnd* pParent /*=NULL*/)
	: CDialogEx(IDD_MY20150269_PRACTICE4_2_DIALOG, pParent)
	, m_strYear(_T(""))
	, m_strMonth(_T(""))
	, m_strDay(_T(""))
	, m_strAMPM(_T(""))
...
void CMy20150269_Practice4_2Dlg::DoDataExchange(CDataExchange* pDX)
{
	CDialogEx::DoDataExchange(pDX);
...
BEGIN_MESSAGE_MAP(CMy20150269_Practice4_2Dlg, CDialogEx)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_COMMAND(IDC_RADIO_12, &CMy20150269_Practice4_2Dlg::OnRadio12)
	ON_COMMAND(IDC_RADIO_24, &CMy20150269_Practice4_2Dlg::OnRadio24)
	ON_BN_CLICKED(IDC_CHECK_YEAR, &CMy20150269_Practice4_2Dlg::OnClickedCheckYear)
	ON_BN_CLICKED(IDC_CHECK_HOUR, &CMy20150269_Practice4_2Dlg::OnClickedCheckHour)
	ON_WM_TIMER()
	ON_BN_CLICKED(IDC_BUTTON_HELP, &CMy20150269_Practice4_2Dlg::OnClickedButtonHelp)
END_MESSAGE_MAP()


// CMy20150269_Practice4_2Dlg 메시지 처리기

BOOL CMy20150269_Practice4_2Dlg::OnInitDialog()
{
...
void CMy20150269_Practice4_2Dlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
void CMy20150269_Practice4_2Dlg::OnPaint()
{
	if (IsIconic())
	{
...
//  이 함수를 호출합니다.
HCURSOR CMy20150269_Practice4_2Dlg::OnQueryDragIcon()
{
...
void CMy20150269_Practice4_2Dlg::OnRadio12()
{
...
void CMy20150269_Practice4_2Dlg::OnRadio24()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	m_bRadioClockType = false;
}
...
void CMy20150269_Practice4_2Dlg::OnClickedCheckYear()
{
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
	if (m_bCheckYear == false)		// "년월일 표시" 체크 박스가 눌렸을 때
	{
...
void CMy20150269_Practice4_2Dlg::OnClickedCheckHour()
{
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
	if (m_bCheckHour == false)		// "시분초 표시" 체크 박스가 눌렸을 때
	{
...
void CMy20150269_Practice4_2Dlg::OnTimer(UINT_PTR nIDEvent)
{
	...
	m_strYear.Format(_T("%d"), timer.GetYear());		// 년도 출력
	m_strMonth.Format(_T("%d"), timer.GetMonth());		// 월 출력
	m_strDay.Format(_T("%d"), timer.GetDay());			// 일 출력

	hour = timer.GetHour();
	if (m_bRadioClockType)								// 12시 베이스
	{
		if (hour >= 12)									// 시간이 12시보다 크면 PM 출력
		{
			m_strAMPM = _T("PM");
			if (hour >= 13)
				hour = hour - 12;
		}
		else											// 시간이 12시보다 작으면 AM 출력
		{
			m_strAMPM = _T("AM");
		}
	}
	...
	m_strHour.Format(_T("%d"), hour);					// 시 출력
	m_strMinute.Format(_T("%d"), timer.GetMinute());	// 분 출력
	m_strSecond.Format(_T("%d"), timer.GetSecond());	// 초 출력
	UpdateData(FALSE);
...
void CMy20150269_Practice4_2Dlg::OnClickedButtonHelp()
{
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
