...
// 20150269_Practice11_1Dlg.cpp : 구현 파일
//

#include "stdafx.h"
#include "20150269_Practice11_1.h"
#include "20150269_Practice11_1Dlg.h"
...
// CMy20150269_Practice11_1Dlg 대화 상자



CMy20150269_Practice11_1Dlg::CMy20150269_Practice11_1Dlg(CWnd* pParent /*=NULL*/)
	: CDialogEx(IDD_MY20150269_PRACTICE11_1_DIALOG, pParent)
	, m_nYear(0)
	, m_nMonth(0)
{
...
void CMy20150269_Practice11_1Dlg::DoDataExchange(CDataExchange* pDX)
{
	CDialogEx::DoDataExchange(pDX);
...
BEGIN_MESSAGE_MAP(CMy20150269_Practice11_1Dlg, CDialogEx)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_CBN_SELCHANGE(IDC_COMBO_MONTH, &CMy20150269_Practice11_1Dlg::OnSelchangeComboMonth)
	ON_NOTIFY(UDN_DELTAPOS, IDC_SPIN_YEAR, &CMy20150269_Practice11_1Dlg::OnDeltaposSpinYear)
END_MESSAGE_MAP()


// CMy20150269_Practice11_1Dlg 메시지 처리기

BOOL CMy20150269_Practice11_1Dlg::OnInitDialog()
{
...
void CMy20150269_Practice11_1Dlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
void CMy20150269_Practice11_1Dlg::OnPaint()
{
	if (IsIconic())
	{
...
//  이 함수를 호출합니다.
HCURSOR CMy20150269_Practice11_1Dlg::OnQueryDragIcon()
{
...
void CMy20150269_Practice11_1Dlg::OnSelchangeComboMonth()
{
...
void CMy20150269_Practice11_1Dlg::OnDeltaposSpinYear(NMHDR *pNMHDR, LRESULT *pResult)
{
	LPNMUPDOWN pNMUpDown = reinterpret_cast<LPNMUPDOWN>(pNMHDR);
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
	// 년도를 설정한다.
	m_nYear += pNMUpDown->iDelta;
	// 최소 년도와 최고 년도의 범위를 벗어나지 않도록 설정한다.
	if (m_nYear <= 1583)
		m_nYear = 1583;
	if (m_nYear > 4040)
		m_nYear = 4040;
